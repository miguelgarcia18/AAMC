        ...
        <div class="container mt-4">
            ...
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    ...
                    <a class="btn btn-light" href="agregar.htm">Registrar libro</a>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>${dato.NombreDelAutor}</td>
                                <td>${dato.EditorialDelLibro}</td>
                                <td>${dato.FechaDePublicacion}</td>
                                <td>${dato.NumeroDePaginas}</td>
                                <td>${dato.Stock}</td>
                                <td>
